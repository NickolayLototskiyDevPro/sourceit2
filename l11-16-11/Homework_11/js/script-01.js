...
function isSubstitute() {
	...
	var str = document.forms.form5.elements.str.value;
	var substrOut = document.forms.form5.elements.substring_out.value;
	var substrIn = document.forms.form5.elements.substring_in.value;

	return res.innerHTML = str.split(substrOut).join(substrIn); 
